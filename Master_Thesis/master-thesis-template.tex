...
If you was supported with the scholarship, please thank to your donor organization
...
\end{abbreviations}
\textbf{Note:} this section is also optional. Keep if if you have abbreviations. \\
...
\end{constants}
\textbf{Note:} this one is also optional. Keep if if you have abbreviations. \\
...
\include{сhapters/1_introduction}
\include{сhapters/2_related_work} 
\include{сhapters/3_theoretical_background}
\include{сhapters/4_proposed_solution} 
\include{сhapters/5_experiments_and_results} 
\include{сhapters/6_conclusions} 
