...
Nemotron-H series~\cite{blakeman2025nemotronh}, AI21's Jamba 1.5
hybrid Transformer-Mamba release~\cite{lenz2024jamba15}, the
Technology Innovation Institute's Falcon Mamba pure-Mamba
LLM~\cite{zuo2024falconmamba}, and Apple's cross-architecture
distillation recipe from Transformer teachers to Mamba
