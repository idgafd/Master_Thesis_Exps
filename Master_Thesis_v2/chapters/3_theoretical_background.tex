...
This chapter develops the conceptual scaffold and the
mathematical machinery on which the proposed mechanisms of
Chapter~\ref{ch:proposed} stand: the axis decomposition of
linear-time recurrent expressivity, the unified causal recurrence
template that places the three matrix backbones inside one
algebraic frame, the LION bidirectional form with its decay-class
taxonomy, the three primitives that supply the mechanisms'
building blocks, and the formal complexity-class bounds that
delimit the diagonal class within which the entire thesis
operates.
