...
predictive criterion. A mechanism's gain on a given task is
...
null when the mechanism extends the function class along an axis
the task does not exercise. The remainder of the thesis is
organised around this criterion.
...
exhibits the criterion in three different signatures across the three
mechanisms.
