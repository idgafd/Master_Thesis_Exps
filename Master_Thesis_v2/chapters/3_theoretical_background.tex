...
mechanism, the Chunked Value Decorrelation, that realises the
same key-similarity decorrelation principle on a linear-time
recurrent substrate, with chunk-local linear systems in place of
the full $T \times T$ preconditioner.
