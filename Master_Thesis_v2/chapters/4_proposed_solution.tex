...
A four-cell engagement classifier crosses the parameter-mobility
signal of each diagnostic with the primary metric outcome,
separating mechanisms that are engaged and helpful from those
engaged without converting into measured gain, those that fail
to engage, and the residual cell. The classifier is defined and
applied in Chapter~\ref{ch:experiments}.
