...
expressivity advantage at matched scale. The comparison varies
depth jointly with parameter count, so the equivalence reading
is at the level of the matched (parameter, serial-compute)
budget rather than at fixed depth; isolating depth as a separate
axis is left to future work.
